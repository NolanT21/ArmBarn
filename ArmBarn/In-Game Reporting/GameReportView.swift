...
//                                        .foregroundStyle(showSavedGames == true ?
...
//                            
                            ...
                            if showGameSummary == true || showSavedGames == true{
        ...
        VStack{
            ...
            HStack{
                VStack (alignment: .leading){
                    ...
                    Text(game_report.start_date.formatted(.dateTime.day().month().year()))
